...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.controller('TabsDemoCtrl', __webpack_require__(4));
	app.controller('TooltipDemoCtrl', function(){});
	app.controller('AccordionDemoCtrl', __webpack_require__(5));
	app.controller('RadioButtonsCtrl', __webpack_require__(6));
	app.controller('CheckboxButtonsCtrl', __webpack_require__(7));
	app.controller('DatepickerDemoCtrl', __webpack_require__(8));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		var rgaaAngularBootstrap = angular
			...
			.factory('getUID', __webpack_require__(298))
			.directive('uniqueId',  [
				'getUID',
			...
			.directive('uibBtnRadio', __webpack_require__(307))
			.directive('uibBtnCheckbox', __webpack_require__(308))
			.directive('uibRating', __webpack_require__(309))
	...
	/***/ (function(module, exports) {
		...
		module.exports = function ($scope, $attrs, accordionConfig) {
		  ...
		  this.initFocusable = function () {
		    var that = this;
		    var index = this.groups.findIndex(function (element) {
	...
	/***/ (function(module, exports) {
		...
		module.exports = function ($timeout) {
		  return {
		    ...
		    controller: 'GroupController',
		    priority: 10000,
		    link: function link(scope, element, attrs, groupCtrl) {
		      $timeout(function () {
		        groupCtrl.initFocusable();

		        var closeOthers = element[0].parentElement.getAttribute('close-others');
		        if (closeOthers) {
		...
		module.exports = function ($document, $timeout) {
		  return {
		    ...
		    link: function link($scope, iElm, iAttrs, controller) {
		      var _$scope$param = $scope.param,
		          recursion = _$scope$param.recursion,
		          autoClick = _$scope$param.autoClick;
	...
	/***/ (function(module, exports) {
		 ...
		 */
		module.exports = function ($templateCache) {
		  $templateCache.put('uib/template/tabs/tab.html', '<li role="tab" ng-class="{active: active, disabled: disabled}" aria-selected="{{active ? \'true\' : \'false\'}}">\n' + '<a tabindex="{{active ? \'0\' : \'-1\'}}" href ng-click="select()" tab-heading-transclude>{{heading}}</a>\n' + '</li>\n' + '');
		};
	...
	/***/ (function(module, exports) {
		 ...
		 */
		module.exports = function ($templateCache) {
		  $templateCache.put('uib/template/accordion/accordion.html', '<div group role="tablist" class="panel-group" ng-transclude></div>');
		};
	...
	/***/ (function(module, exports) {
		 ...
		 */
		module.exports = function ($templateCache) {
			$templateCache.put('uib/template/rating/rating.html', '<span ng-mouseleave=\"reset()\" ng-keydown=\"onKeydown($event)\" tabindex=\"0\" role=\"slider\" aria-valuemin=\"0\" aria-valuemax=\"{{range.length}}\" aria-valuenow=\"{{value}}\" aria-valuetext=\"{{value}} étoile{{ value > 1 ? \'s\' :  \'\' }}\">\n' + '    <span ng-repeat-start=\"r in range track by $index\" class=\"sr-only\">({{ $index < value ? \'*\' : \' \' }})</span>\n' + '    <i ng-repeat-end ng-mouseenter=\"enter($index + 1)\" ng-click=\"rate($index + 1)\" class=\"glyphicon\" ng-class=\"$index < value && (r.stateOn || \'glyphicon-star\') || (r.stateOff || \'glyphicon-star-empty\')\" ng-attr-title=\"{{r.title}}\"></i>\n' + '</span>\n' + '');
		};
	...
	/***/ (function(module, exports) {
		 ...
		 */
		module.exports = function ($templateCache) {
		  $templateCache.put('uib/template/progressbar/progressbar.html', '<div class=\"progress\" tabindex=\"0\" aria-labelledby=\"{{::title}}\" role=\"progressbar\" aria-valuenow=\"{{value}}\" aria-valuemin=\"0\" aria-valuemax=\"{{max}}\" aria-valuetext=\"{{percent | number:0}}%\" aria-labelledby=\"{{::title}}\">\n' + '	<div  class=\"progress-bar\" ng-class=\"type && \'progress-bar-\' + type\"  ng-style=\"{width: (percent < 100 ? percent : 100) + \'%\'}\" ng-transclude></div>\n' + '</div>\n' + '');
		};
